...
var cookieDecoder = require("./node_rails_cookies_decoder.js")(options);
var ChartModule = require("./chart_module.js");
...
var d3_cdn_path = "//cdnjs.cloudflare.com/ajax/libs/d3/3.4.11/d3.js",
	...
	url_to_file_map = {
		"/interaction/interaction" : "interaction_chart_interaction.js",
		"/interaction/to_send" : "interaction_chart_to_send.js",
		"/interaction/style" : "interaction_chart_style.css",
		"/pareto/interaction" : "pareto_chart_interaction.js",
		"/pareto/to_send" : "pareto_chart_to_send.js",
		"/pareto/style" : "pareto_chart_style.css",
		"/d3_legend" : "d3.legend.js"
	};
...
var app = http.createServer(function(req, res) {
	...
	if(pathname==="/interaction") {
		authenticate(req.headers.cookie, parameters["id"], function(data) {
			...
			ChartModule.prepare_interaction_chart(parameters["id"],
							      parameters["param1"],
							      parameters["param2"], 
							      function(data) {
				...
				if(parameters["func_defined"]==='false') {
					// res.write(tags.script_tag_d3_legend);
		...
		ChartModule.prepare_pareto_chart(parameters["id"], function(htmlChart) {
...
function prepare_script_and_style_tags(typeOfChart) {
	...
	tags.script_tag_d3_legend = jsdom.createElement("script");
	tags.script_tag_d3_legend.setAttribute("type", "text/javascript");
	tags.script_tag_d3_legend.setAttribute("src", "//" + ADDRESS + "/d3_legend");
...
function authenticate(cookie, experimentID, success, error){
	...
	exec("ruby script.rb " + new Buffer(output).toString("base64"), function(errorExec, stdout, stderr) {
		var userID = JSON.parse(stdout)["user"];
		console.log("\tuserID: ", userID); 
		console.log("\texperimentID: ", experimentID);

		ChartModule.authenticate(userID, experimentID, function(dataSuccess) {
			success(dataSuccess);
		}, function(dataError) {
			error(dataError);
		});
